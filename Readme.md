...
src/ub-timeline/               # UB Timeline block (dynamic + Interactivity API)
...
| Block | Name | Notes |
| --- | --- | --- |
| **UB Timeline** | `wp-usefull-blocks/ub-timeline` | Title/description entries; vertical or horizontal; click title to toggle description |
